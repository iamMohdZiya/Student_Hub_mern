    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-950 px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 flex items-center justify-center shadow-xl">
        ...
        <form onSubmit={handleRegister} className="premium-card">
          <div className="p-8">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="input-premium w-full pl-12 focus-premium"
                    value={name}
            ...
            <button
              type="submit"
              disabled={loading}
              className={`w-full mt-8 btn-linkedin py-4 text-lg font-bold flex items-center justify-center space-x-2 ${
            ...
            >
              {loading ? (
                ...
                <>
                  ...
                  <span>Create StudentHub Account</span>
                </>
              )}
            </button>
            ...
            <div className="mt-8 p-4 rounded-2xl border border-white/10 bg-white/5">
              ...
              <div className="space-y-2 text-sm text-slate-300">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span>Share your achievements and projects</span>
                </div>
                <div className="flex items-center space-x-2">
                  <svg className="w-4 h-4 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
